...
\thesistitle{Cytogenetic and Molecular Genetic Evaluation of Genomic Rearrangements in Children with Intellectual Disability} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Venkatachalam \textsc{P}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Doctor of Philosophy} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Shruthi \textsc{M}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
